SetupLawyers = function(data) {
    ...
    if (data.length > 0) {
        ...
        $(".lawyers-list").append('<br><h1 style="font-size:1.641025641025641vh; padding:1.0256410256410255vh; color:#fff; margin-top:0; width:100%; display:block; background-color: rgb(155, 15, 120);">LSPD (' + police.length + ')</h1>');

        if (police.length > 0) {
            $.each(police, function(i, lawyer1) {
